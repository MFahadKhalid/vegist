                            ...
                            <div class="check-out-3">
                                <div class="check-pro">
                                    ...
                                    <form>
                                        ...
                                        <ul class="style-3-check-pro selector">
                                            <li>
                                    ...
                                    <div class="pay-op">
                                        ...
                                        <a href="javascript:void(0)" class="pay-link pay-link-1">Check out with : <i class="fa fa-paypal"></i></a>
                                        <a href="javascript:void(0)" class="pay-link pay-link-2">Check out with : <i class="fa fa-google"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="check-out-3">
                            ...
                            <div class="check-out-3">
                                <div class="pay-method">
                                    ...
                                    <div class="order-summary">
                                        ...
                                        <ul>
                                            <li>
                                                <span class="p-name">Fresh healthy food</span>
                                                <span class="p-price">$93.00</span>
                                            </li>
                                            <li>
                                                <span class="p-name">Fresh green orange</span>
                                                <span class="p-price">$230.00</span>
                                            </li>
                                            <li>
                                                <span class="p-name">Total</span>
                                                <span class="p-price">$320.00</span>
                                            </li>
                                            <li>
                                                <span class="p-name">Shipping to india</span>
                                                <span class="p-price">$6</span>
                                            </li>
                                            <li class="order-total">
                                                <span class="p-name">Order total</span>
                                                <span class="p-price">$326</span>
                                            </li>
                                        </ul>
                                        <div class="check-btn">
                                            <a href="{{route('vegist.ordercomplete')}}" class="btn-style1">Complete order</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
