                                ...
                                <div class="cart-all-pro">
                                    <div class="cart-pro">
                                        <div class="cart-pro-image">
                                            <a href="product.html"><img src="image/cart-page/cart-1/image1.jpg" class="img-fluid" alt="image"></a>
                                        </div>
                        ...
                        <div class="cart-area">
                            <div class="cart-details">
                                <div class="cart-all-pro">
                                    <div class="cart-pro">
                                        <div class="cart-pro-image">
                                            <a href="product.html"><img src="image/cart-page/cart-1/image3.jpg" class="img-fluid" alt="image"></a>
                                        </div>
                                        <div class="pro-details">
                        ...
                        <div class="cart-area">
                            <div class="cart-details">
                                <div class="cart-all-pro">
                                    <div class="cart-pro">
                                        <div class="cart-pro-image">
                                            <a href="product.html"><img src="image/cart-page/cart-1/image2.jpg" class="img-fluid" alt="image"></a>
                                        </div>
                                        <div class="pro-details">
                                ...
                                <div class="other-link">
                                    <ul class="c-link">
                                        ...
                                        <li class="cart-other-link"><a href="index3.html">Clear cart</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="c-total">
                                <ul>
                                    <li class="c-all-price">
                                        <span>Subtotal</span>
                                        <span>$953.51 USD</span>
                                    </li>
                                </ul>
                                <div class="recive-details">
                                    <h4 class="recive-title">Get shipping estimates</h4>
                                    <form>
                                        <div class="form-1">
                                            <ul>
                                                <li>
                                                ...
                                                <li>
                                                    <a href="javascript:void(0)" class="btn-style1">Calculate shipping</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="form-2">
                                            <ul class="recive-comments-area">
                                                <li class="recive-comments">
                                                    ...
                                                    <textarea name="text" rows="5" cols="5" placeholder="How can we help you?"></textarea>
                                                </li>
                                                <li class="recive-comments">
                                                    <a href="{{route('vegist.checkout')}}" class="btn-style1">Checkout</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </form>
