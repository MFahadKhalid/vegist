...
@section('content')
                            ...
                            <div class="main-navigation navbar-expand-xl">
                                            ...
                                            <ul class="main-menu">
                                                <li class="menu-link parent">
                                                    ...
                                                    <ul class="dropdown-submenu sub-menu collapse" id="collapse-home1">
                                                        ...
                                                        <li class="submenu-li">
                                                            <a href="{{route('vegist.index')}}" class="submenu-link">Vegist home 03</a>
                                                        </li>
                                                        <li class="submenu-li">
                                ...
                                <div class="img-hotline">
                                    <div class="image-line">
                                        <a href="javascript:void(0)"><img src="{{asset('image/icon_contact.png')}}" class="img-fluid" alt="image-icon"></a>
                                    </div>
        ...
        <section class="slider">
            <div class="home-slider owl-carousel owl-theme">
                <div class="items">
                    <div class="img-back" style="background-image:url({{asset('image/slider1.jpg')}});">
                ...
                <div class="items">
                    <div class="img-back" style="background-image:url({{asset('image/slider2.jpg')}});">
                ...
                <div class="items">
                    <div class="img-back" style="background-image:url({{asset('image/slider3.jpg')}});">
                        ...
                        <div class="home-offer-banner">
                            <div class="o-t-banner">
                                <a href="product.html" class="image-b">
                                    <img class="img-fluid" src="{{asset('image/banner-1.jpg')}}" alt="banner image">
                                </a>
                            ...
                            <div class="o-t-banner">
                                <a href="product.html" class="image-b">
                                    <img class="img-fluid" src="{{asset('image/banner-2.jpg')}}" alt="banner image">
                                </a>
                        ...
                        <div class="home-category owl-carousel owl-theme">
                                ...
                                <div class="h-cate">
                                    <div class="c-img">
                                        <a href="grid-list.html" class="home-cate-img">
                                            <img class="img-fluid" src="{{asset('image/category-image/home-1/cat1.jpg')}}" alt="cate-image">
                            ...
                            <div class="items">
                                <div class="h-cate">
                                    <div class="c-img">
                                        <a href="grid-list.html" class="home-cate-img">
                                            <img class="img-fluid" src="{{asset('image/category-image/home-1/cat2.jpg')}}" alt="cate-image">
                            ...
                            <div class="items">
                                <div class="h-cate">
                                    <div class="c-img">
                                        <a href="grid-list.html" class="home-cate-img">
                                            <img class="img-fluid" src="{{asset('image/category-image/home-1/cat3.jpg')}}" alt="cate-image">
                            ...
                            <div class="items">
                                <div class="h-cate">
                                    <div class="c-img">
                                        <a href="grid-list.html" class="home-cate-img">
                                            <img class="img-fluid" src="{{asset('image/category-image/home-1/cat4.jpg')}}" alt="cate-image">
                            ...
                            <div class="items">
                                <div class="h-cate">
                                    <div class="c-img">
                                        <a href="grid-list.html" class="home-cate-img">
                                            <img class="img-fluid" src="{{asset('image/category-image/home-1/cat5.jpg')}}" alt="cate-image">
                            ...
                            <div class="items">
                                <div class="h-cate">
                                    <div class="c-img">
                                        <a href="grid-list.html" class="home-cate-img">
                                            <img class="img-fluid" src="{{asset('image/category-image/home-1/cat6.jpg')}}" alt="cate-image">
                            ...
                            <div class="items">
                                <div class="h-cate">
                                    <div class="c-img">
                                        <a href="grid-list.html" class="home-cate-img">
                                            <img class="img-fluid" src="{{asset('image/category-image/home-1/cat7.jpg')}}" alt="cate-image">
                            ...
                            <div class="items">
                                <div class="h-cate">
                                    <div class="c-img">
                                        <a href="grid-list.html" class="home-cate-img">
                                            <img class="img-fluid" src="{{asset('image/category-image/home-1/cat8.jpg')}}" alt="cate-image">
                            ...
                            <div class="items">
                                <div class="h-cate">
                                    <div class="c-img">
                                        <a href="grid-list.html" class="home-cate-img">
                                            <img class="img-fluid" src="{{asset('image/category-image/home-1/cat9.jpg')}}" alt="cate-image">
        ...
        <section class="home-countdown1">
            <div class="back-img" style="background-image: url({{asset('image/dealbanner.jpg')}});">
                <div class="container">
                    <div class="row">
                        <div class="col">
        ...
        <section class="news-letter1">
            <div class="section-tb-padding news-img" style="background-image: url({{asset('image/banner3.jpg')}});">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <div class="home-news">
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        <div class="popup-content">
                            ...
                            <div class="pop-up-newsletter" style="background-image: url({{asset('image/news-popup.jpg')}});">
